...
//            thuocItem.setEnabled(false);
    ...
    private void initComponents() {
        ...
        leftContent.setBackground(new Color(230, 245, 245));
        leftContent.setPreferredSize(new java.awt.Dimension(250, 800));

        sidebarPanel.setBackground(new Color(255, 255, 255));
        sidebarPanel.setBorder(new javax.swing.border.LineBorder(new Color(242, 242, 242), 2, true));
        ...
        itemPanel.setBorder(new javax.swing.border.LineBorder(new Color(255, 255, 255), 8, true));
...
//        thuocItem.setIcon(new FlatSVGIcon("./icon/medicine.svg"));
        ...
        jPanel5.setBorder(new javax.swing.border.LineBorder(new Color(255, 255, 255), 10, true));
        ...
        infoPanel.setBorder(new javax.swing.border.LineBorder(new Color(242, 242, 242), 2, true));
        infoPanel.setForeground(new Color(243, 243, 243));
        ...
        mainContent.setBackground(new Color(243, 255, 255));
