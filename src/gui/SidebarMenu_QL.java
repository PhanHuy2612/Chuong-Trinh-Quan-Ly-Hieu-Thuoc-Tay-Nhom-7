...
public class SidebarMenu_QL extends VBox {
    ...
    public SidebarMenu_QL(String tenDangNhap, String tenNhanVien, Runnable onLogout) {
        setPrefWidth(230);
    ...
    private void initializeIcons() {
        menuIcons.put("Dashboard", "/img/icon_ThongKe.png");
        menuIcons.put("Quản lý nhân viên", "/img/icon_KhachHang.png");
        menuIcons.put("Thống kê", "/img/icon_ThongKe.png");
        menuIcons.put("Quản lý ca làm", "/img/icon_ThoiGian.png");
        menuIcons.put("Quản lý trả hàng", "/img/icon_TraHang.png");
        menuIcons.put("Quản lý khuyến mãi", "/img/icon_KhuyenMai.png");
    ...
    private void buildUI(String tenDangNhap, String tenNhanVien, Runnable onLogout) {
        ...
        roleLabel = new Label("Quản lý"); // VAI TRÒ MỚI
    ...
    public void setMenuAction(String menuText, Runnable action) {
        ...
        for (javafx.scene.Node node : getChildren()) {
            if (node instanceof Button btn && menuText.equals(btn.getText())) {
                btn.setOnAction(e -> action.run());
                System.out.println("[DEBUG] Đã gán action cho menu QL: " + menuText);
                break;
            }
        }
    }
